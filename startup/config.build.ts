...
function belong<U extends string, T extends U>(elements: readonly T[], e: U): e is T
{
...
const userSpecified: { arch?: 'arm64' | 'x64', os?: 'windows' | 'linux' | 'macos' } = {}
...
export const targetPlatform: { arch: 'arm64' | 'x64', os: 'windows' | 'linux' | 'macos' } =
{
