...
export type RepoTargetParams<It extends BuildDependencies> =
  & Omit<Omit<TargetParams<It>, "name">, "build">
  & {
    repo: string;
...
export function repoTarget<It extends BuildDependencies>(
  params: RepoTargetParams<It>,
)
{
